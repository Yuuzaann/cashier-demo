...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 26, 2025 at 03:36 AM
...
INSERT INTO `pelanggan` (`id`, `nama`, `alamat`, `telp`) VALUES
(1, 'Tamu', '-', '081234567890'),
(2, 'PT Contoh', 'Jl. Mawar No.1', '0811223344'),
(3, 'PT JAYA', '-', '63345');
...
(1, 'Pensil', 1500.00, 100),
(2, 'Buku Tulis', 8000.00, 49),
(3, 'Pulpen', 3000.00, 20);
...
(1, '2025-09-25 10:58:25', 2, 8000.00);
...
INSERT INTO `transaksi_detail` (`id`, `transaksi_id`, `produk_id`, `qty`, `subtotal`) VALUES
(1, 1, 2, 1, 8000.00);
...
(2, 'kasir', 'de28f8f7998f23ab4194b51a6029416f', 'kasir');
