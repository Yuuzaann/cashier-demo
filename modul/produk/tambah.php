...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    tambah_produk($_POST['nama'], $_POST['harga'], $_POST['stok']);
...
<form method="post" class="animate-form">
  <div class="mb-3">
    ...
    <input type="text" name="nama" class="form-control animate-input" required>
  </div>

  <div class="mb-3">
    <label class="form-label">Harga</label>
    <input type="number" name="harga" class="form-control animate-input" required>
  </div>

  <div class="mb-3">
    <label class="form-label">Stok</label>
    <input type="number" name="stok" class="form-control animate-input" required>
  </div>
