...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    tambah_pelanggan($_POST['nama'], $_POST['alamat'], $_POST['telp']);
    echo '<div class="alert alert-success animate-msg">Pelanggan ditambahkan. 
...
<form method="post" class="animate-form">
  <div class="mb-3">
    ...
    <input name="nama" class="form-control animate-input" required>
  </div>
  <div class="mb-3">
    <label class="form-label">Telp</label>
    <input name="telp" class="form-control animate-input">
  </div>
  <div class="mb-3">
    <label class="form-label">Alamat</label>
    <textarea name="alamat" class="form-control animate-input"></textarea>
  </div>
